...
var useraddressinput = GSModule.create({
	...
	onMounting : function() {
		this._address = {
			street : this._props.user.mail_address,
			city : this._props.user.mail_city,
			state : this._props.user.mail_state,
			country : this._props.user.mail_country,
			zip : this._props.user.mail_zip,
		};
	},
	...
	render : function() {
		...
		var addressList = [];
		addressList.push('<input class="__Customer__itemInput" type="text" name="mail_address" value={this._address.street} placeholder="Mail Street Address" onkeyup={this._onStreetChanged}></input>');
		addressList.push('<input class="__Customer__itemInput2" type="text" name="mail_city" value={this._address.city} placeholder="City" onkeyup={this._onCityChanged}></input>');
		addressList.push('<input class="__Customer__itemInput2" type="text" name="mail_state" value={this._address.state} placeholder="State" onkeyup={this._onStateChanged}></input>');
		addressList.push('<input class="__Customer__itemInput2" type="text" name="mail_country" value={this._address.country} placeholder="Country" onkeyup={this._onCountryChanged}></input>');
		addressList.push('<input class="__Customer__itemInput2" type="text" name="mail_zip" value={this._address.zip} placeholder="Zip" onkeyup={this._onZipChanged}></input>');
